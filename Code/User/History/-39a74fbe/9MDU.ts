...
export class CardService {
  ...
  async exportCard(id: number): Promise<any> {
    ...
    this.writeToPage(frontPage, templateInformations.front.informations, card.data.front)
    ...
    this.writeToPage(backPage, templateInformations.back.informations, card.data.back)
  ...
  private writeToPage(page: PDFPage, template: object, card: object){
