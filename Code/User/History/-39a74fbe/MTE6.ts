...
export class CardService {
  ...
  async exportCard(id: number, query: any): Promise<any> {
    ...
    // @ts-ignore
    const frontImageArrayBuffer = this.prepareImage(templateInformations.front.background);
    // @ts-ignore
    const backImageArrayBuffer = this.prepareImage(templateInformations.back.background)
