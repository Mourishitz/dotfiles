...
export class CardService {
  ...
  async exportCard(id: number, query: any): Promise<any> {
    ...
    // @ts-ignore
    const frontImage = this.prepareImage(templateInformations.front.background);
    // @ts-ignore
    const backImageUrl = templateInformations.back.background
  ...
  private prepareImage(base64: string) {
